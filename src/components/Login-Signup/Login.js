...
//           <Form.Input onInput={props.updateState} name="username" fluid label='Username' placeholder='Username' />
//           <Form.Input onInput={props.updateState} name="password" fluid label='Password' placeholder='Password' />
